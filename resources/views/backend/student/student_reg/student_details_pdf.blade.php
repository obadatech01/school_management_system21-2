...
<table id="customers">
    <tr>
        ...
        <td>
            ...
            <p>School Address</p>
            <p>Phone: 00972595961289</p>
            <p>Email: obadamusameh@gmail.com</p>
        </td>
    </tr>
</table>
...
<table id="customers">
  ...
  <!-- <tr>
    <td>16</td>
    <td><b>Photo</b></td>
    <td><img id="showImage" src="{{(!empty($details['student']['image'])) ? url('upload/student_images/'.$details['student']['image']) : url('upload/no_image.jpg')}}" style="width:60px;height:60px;border:1px solid #000;" /></td>
  </tr> -->
</table>
<br><br>
